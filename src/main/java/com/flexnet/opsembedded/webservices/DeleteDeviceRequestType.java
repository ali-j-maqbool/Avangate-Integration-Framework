...
public class DeleteDeviceRequestType  implements java.io.Serializable {
    private com.flexnet.opsembedded.webservices.DeviceIdentifier[] deviceIdentifier;

    public DeleteDeviceRequestType() {
    }
    ...
    /**
     * Gets the deviceIdentifier value for this DeleteDeviceRequestType.
     * 
    ...
    /**
     * Sets the deviceIdentifier value for this DeleteDeviceRequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteDeviceRequestType)) return false;
        DeleteDeviceRequestType other = (DeleteDeviceRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteDeviceRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "deleteDeviceRequestType"));
