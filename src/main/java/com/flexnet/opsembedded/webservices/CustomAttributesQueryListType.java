...
public class CustomAttributesQueryListType  implements java.io.Serializable {
    private com.flexnet.opsembedded.webservices.CustomAttributeQueryType[] attribute;

    public CustomAttributesQueryListType() {
    }

    public CustomAttributesQueryListType(
           com.flexnet.opsembedded.webservices.CustomAttributeQueryType[] attribute) {
     ...
     * @return attribute
     */
    public com.flexnet.opsembedded.webservices.CustomAttributeQueryType[] getAttribute() {
        return attribute;
    }
     ...
     * @param attribute
     */
    public void setAttribute(com.flexnet.opsembedded.webservices.CustomAttributeQueryType[] attribute) {
        this.attribute = attribute;
    }

    public com.flexnet.opsembedded.webservices.CustomAttributeQueryType getAttribute(int i) {
        return this.attribute[i];
    }

    public void setAttribute(int i, com.flexnet.opsembedded.webservices.CustomAttributeQueryType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "customAttributesQueryListType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "customAttributeQueryType"));
