...
public class MoveDeviceList  implements java.io.Serializable {
    private com.flexnet.opsembedded.webservices.DeviceIdentifier[] deviceIdentifier;

    public MoveDeviceList() {
    }
    ...
    /**
     * Gets the deviceIdentifier value for this MoveDeviceList.
     * 
    ...
    /**
     * Sets the deviceIdentifier value for this MoveDeviceList.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MoveDeviceList)) return false;
        MoveDeviceList other = (MoveDeviceList) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MoveDeviceList.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "moveDeviceList"));
