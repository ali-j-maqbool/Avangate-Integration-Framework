...
public class NumberQueryType  implements java.io.Serializable {
    ...
    private com.flexnet.opsembedded.webservices.NumberSearchType searchType;
    ...
    public NumberQueryType(
           ...
           com.flexnet.opsembedded.webservices.NumberSearchType searchType) {
           this.value = value;
     ...
     * @return searchType
     */
    public com.flexnet.opsembedded.webservices.NumberSearchType getSearchType() {
        return searchType;
    }
     ...
     * @param searchType
     */
    public void setSearchType(com.flexnet.opsembedded.webservices.NumberSearchType searchType) {
        this.searchType = searchType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "NumberQueryType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "numberSearchType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
