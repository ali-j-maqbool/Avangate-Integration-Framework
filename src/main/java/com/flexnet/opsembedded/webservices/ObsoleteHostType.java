...
public class ObsoleteHostType  implements java.io.Serializable {
    private com.flexnet.opsembedded.webservices.DeviceIdentifier hostIdentifier;

    public ObsoleteHostType() {
    }
    ...
    /**
     * Gets the hostIdentifier value for this ObsoleteHostType.
     * 
    ...
    /**
     * Sets the hostIdentifier value for this ObsoleteHostType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ObsoleteHostType)) return false;
        ObsoleteHostType other = (ObsoleteHostType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ObsoleteHostType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "obsoleteHostType"));
