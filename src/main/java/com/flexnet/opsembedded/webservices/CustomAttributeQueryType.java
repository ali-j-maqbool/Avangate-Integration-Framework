...
public class CustomAttributeQueryType  implements java.io.Serializable {
    ...
    private com.flexnet.opsembedded.webservices.SimpleQueryType stringValue;

    private com.flexnet.opsembedded.webservices.NumberQueryType numberValue;

    private com.flexnet.opsembedded.webservices.DateQueryType dateValue;
    ...
    public CustomAttributeQueryType(
           ...
           com.flexnet.opsembedded.webservices.SimpleQueryType stringValue,
           com.flexnet.opsembedded.webservices.NumberQueryType numberValue,
           com.flexnet.opsembedded.webservices.DateQueryType dateValue,
     ...
     * @return stringValue
     */
    public com.flexnet.opsembedded.webservices.SimpleQueryType getStringValue() {
        return stringValue;
    }
     ...
     * @param stringValue
     */
    public void setStringValue(com.flexnet.opsembedded.webservices.SimpleQueryType stringValue) {
        this.stringValue = stringValue;
    }
     ...
     * @return numberValue
     */
    public com.flexnet.opsembedded.webservices.NumberQueryType getNumberValue() {
        return numberValue;
    }
     ...
     * @param numberValue
     */
    public void setNumberValue(com.flexnet.opsembedded.webservices.NumberQueryType numberValue) {
        this.numberValue = numberValue;
    }
     ...
     * @return dateValue
     */
    public com.flexnet.opsembedded.webservices.DateQueryType getDateValue() {
        return dateValue;
    }
     ...
     * @param dateValue
     */
    public void setDateValue(com.flexnet.opsembedded.webservices.DateQueryType dateValue) {
        this.dateValue = dateValue;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "customAttributeQueryType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "DateQueryType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
