...
public class UserIdentifierType  implements java.io.Serializable {
    ...
    private com.flexnet.opsembedded.webservices.UserPKType primaryKeys;
    ...
    public UserIdentifierType(
           ...
           com.flexnet.opsembedded.webservices.UserPKType primaryKeys) {
     ...
     * @return primaryKeys
     */
    public com.flexnet.opsembedded.webservices.UserPKType getPrimaryKeys() {
        return primaryKeys;
    }
     ...
     * @param primaryKeys
     */
    public void setPrimaryKeys(com.flexnet.opsembedded.webservices.UserPKType primaryKeys) {
        this.primaryKeys = primaryKeys;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "userIdentifierType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "userName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "userPKType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
