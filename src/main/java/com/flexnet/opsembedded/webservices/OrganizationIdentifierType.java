...
public class OrganizationIdentifierType  implements java.io.Serializable {
    ...
    private com.flexnet.opsembedded.webservices.OrganizationPKType primaryKeys;
    ...
    public OrganizationIdentifierType(
           ...
           com.flexnet.opsembedded.webservices.OrganizationPKType primaryKeys) {
     ...
     * @return primaryKeys
     */
    public com.flexnet.opsembedded.webservices.OrganizationPKType getPrimaryKeys() {
        return primaryKeys;
    }
     ...
     * @param primaryKeys
     */
    public void setPrimaryKeys(com.flexnet.opsembedded.webservices.OrganizationPKType primaryKeys) {
        this.primaryKeys = primaryKeys;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "organizationIdentifierType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "organizationPKType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
