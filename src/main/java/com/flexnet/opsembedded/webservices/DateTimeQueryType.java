...
public class DateTimeQueryType  implements java.io.Serializable {
    ...
    private com.flexnet.opsembedded.webservices.DatedSearchType searchType;
    ...
    public DateTimeQueryType(
           ...
           com.flexnet.opsembedded.webservices.DatedSearchType searchType) {
           this.value = value;
     ...
     * @return searchType
     */
    public com.flexnet.opsembedded.webservices.DatedSearchType getSearchType() {
        return searchType;
    }
     ...
     * @param searchType
     */
    public void setSearchType(com.flexnet.opsembedded.webservices.DatedSearchType searchType) {
        this.searchType = searchType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "DateTimeQueryType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/opsembedded", "datedSearchType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
