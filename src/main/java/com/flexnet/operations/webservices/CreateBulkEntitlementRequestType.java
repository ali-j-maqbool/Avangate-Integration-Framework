/**
 * CreateBulkEntitlementRequestType.java
 *
...
public class CreateBulkEntitlementRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.CreateBulkEntitlementDataType[] bulkEntitlement;

    public CreateBulkEntitlementRequestType() {
    }
    ...
    /**
     * Gets the bulkEntitlement value for this CreateBulkEntitlementRequestType.
     * 
    ...
    /**
     * Sets the bulkEntitlement value for this CreateBulkEntitlementRequestType.
     * 
    ...
    public com.flexnet.operations.webservices.CreateBulkEntitlementDataType getBulkEntitlement(int i) {
        return this.bulkEntitlement[i];
    }

    public void setBulkEntitlement(int i, com.flexnet.operations.webservices.CreateBulkEntitlementDataType _value) {
        this.bulkEntitlement[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateBulkEntitlementRequestType)) return false;
        CreateBulkEntitlementRequestType other = (CreateBulkEntitlementRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateBulkEntitlementRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "createBulkEntitlementRequestType"));
