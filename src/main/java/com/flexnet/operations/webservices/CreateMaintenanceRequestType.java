/**
 * CreateMaintenanceRequestType.java
 *
...
public class CreateMaintenanceRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.CreateMaintenanceDataType[] maintenance;

    public CreateMaintenanceRequestType() {
    }
    ...
    /**
     * Gets the maintenance value for this CreateMaintenanceRequestType.
     * 
     * @return maintenance
     */
    ...
    /**
     * Sets the maintenance value for this CreateMaintenanceRequestType.
     * 
     * @param maintenance
     */
    ...
    public com.flexnet.operations.webservices.CreateMaintenanceDataType getMaintenance(int i) {
        return this.maintenance[i];
    }

    public void setMaintenance(int i, com.flexnet.operations.webservices.CreateMaintenanceDataType _value) {
        this.maintenance[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateMaintenanceRequestType)) return false;
        CreateMaintenanceRequestType other = (CreateMaintenanceRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateMaintenanceRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "createMaintenanceRequestType"));
