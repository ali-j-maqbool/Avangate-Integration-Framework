...
public class UpdateHostTypeListType  implements java.io.Serializable {
    ...
    /**
     * Gets the hostType value for this UpdateHostTypeListType.
     * 
     * @return hostType
     */
    ...
    /**
     * Sets the hostType value for this UpdateHostTypeListType.
     * 
     * @param hostType
     */
    ...
    public com.flexnet.operations.webservices.HostTypePKType getHostType(int i) {
        return this.hostType[i];
    }

    public void setHostType(int i, com.flexnet.operations.webservices.HostTypePKType _value) {
        this.hostType[i] = _value;
    }


    /**
     * Gets the opType value for this UpdateHostTypeListType.
     * 
     * @return opType
     */
    ...
    /**
     * Sets the opType value for this UpdateHostTypeListType.
     * 
     * @param opType
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateHostTypeListType)) return false;
        UpdateHostTypeListType other = (UpdateHostTypeListType) obj;
        ...
        _equals = true && 
            ((this.hostType==null && other.getHostType()==null) || 
             (this.hostType!=null &&
              java.util.Arrays.equals(this.hostType, other.getHostType()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getHostType() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getHostType());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getHostType(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateHostTypeListType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "updateHostTypeListType"));
