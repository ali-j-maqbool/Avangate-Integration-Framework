/**
 * GetBulkEntitlementCountResponseType.java
 *
...
public class GetBulkEntitlementCountResponseType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.StatusInfoType statusInfo;

    private java.math.BigInteger count;

    public GetBulkEntitlementCountResponseType() {
    }
    ...
    /**
     * Gets the statusInfo value for this GetBulkEntitlementCountResponseType.
     * 
     * @return statusInfo
     */
    ...
    /**
     * Sets the statusInfo value for this GetBulkEntitlementCountResponseType.
     * 
     * @param statusInfo
     */
    ...
    /**
     * Gets the count value for this GetBulkEntitlementCountResponseType.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this GetBulkEntitlementCountResponseType.
     * 
     * @param count
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetBulkEntitlementCountResponseType)) return false;
        GetBulkEntitlementCountResponseType other = (GetBulkEntitlementCountResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetBulkEntitlementCountResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "getBulkEntitlementCountResponseType"));
