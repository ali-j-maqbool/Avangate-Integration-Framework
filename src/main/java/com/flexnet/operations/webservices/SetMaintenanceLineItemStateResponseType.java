...
public class SetMaintenanceLineItemStateResponseType  implements java.io.Serializable {
    ...
    private com.flexnet.operations.webservices.FailedMaintenanceLineItemStateDataListType failedMaintenanceData;
    ...
    public SetMaintenanceLineItemStateResponseType(
           ...
           com.flexnet.operations.webservices.FailedMaintenanceLineItemStateDataListType failedMaintenanceData) {
     ...
     */
    public com.flexnet.operations.webservices.FailedMaintenanceLineItemStateDataListType getFailedMaintenanceData() {
        return failedMaintenanceData;
    }
     ...
     */
    public void setFailedMaintenanceData(com.flexnet.operations.webservices.FailedMaintenanceLineItemStateDataListType failedMaintenanceData) {
        this.failedMaintenanceData = failedMaintenanceData;
    }
        ...
        _equals = true && 
            ...
            ((this.failedMaintenanceData==null && other.getFailedMaintenanceData()==null) || 
             (this.failedMaintenanceData!=null &&
              this.failedMaintenanceData.equals(other.getFailedMaintenanceData())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFailedMaintenanceData() != null) {
            _hashCode += getFailedMaintenanceData().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "setMaintenanceLineItemStateResponseType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "failedMaintenanceData"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "failedMaintenanceLineItemStateDataListType"));
