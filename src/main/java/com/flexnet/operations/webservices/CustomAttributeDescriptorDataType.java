...
public class CustomAttributeDescriptorDataType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.CustomAttributeDescriptorType[] attribute;

    public CustomAttributeDescriptorDataType() {
    }

    public CustomAttributeDescriptorDataType(
           com.flexnet.operations.webservices.CustomAttributeDescriptorType[] attribute) {
     ...
     * @return attribute
     */
    public com.flexnet.operations.webservices.CustomAttributeDescriptorType[] getAttribute() {
        return attribute;
    }
     ...
     * @param attribute
     */
    public void setAttribute(com.flexnet.operations.webservices.CustomAttributeDescriptorType[] attribute) {
        this.attribute = attribute;
    }

    public com.flexnet.operations.webservices.CustomAttributeDescriptorType getAttribute(int i) {
        return this.attribute[i];
    }

    public void setAttribute(int i, com.flexnet.operations.webservices.CustomAttributeDescriptorType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "customAttributeDescriptorDataType"));
