...
public class LicenseModelIdentifierType  implements java.io.Serializable {
    ...
    private com.flexnet.operations.webservices.LicenseModelPKType primaryKeys;
    ...
    public LicenseModelIdentifierType(
           ...
           com.flexnet.operations.webservices.LicenseModelPKType primaryKeys) {
     ...
     * @return primaryKeys
     */
    public com.flexnet.operations.webservices.LicenseModelPKType getPrimaryKeys() {
        return primaryKeys;
    }
     ...
     * @param primaryKeys
     */
    public void setPrimaryKeys(com.flexnet.operations.webservices.LicenseModelPKType primaryKeys) {
        this.primaryKeys = primaryKeys;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "licenseModelIdentifierType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "licenseModelPKType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
