...
public class LicenseModelsListType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.LicenseModelIdentifierType[] licenseModel;

    public LicenseModelsListType() {
    }
    ...
    /**
     * Gets the licenseModel value for this LicenseModelsListType.
     * 
     * @return licenseModel
     */
    ...
    /**
     * Sets the licenseModel value for this LicenseModelsListType.
     * 
     * @param licenseModel
     */
    ...
    public com.flexnet.operations.webservices.LicenseModelIdentifierType getLicenseModel(int i) {
        return this.licenseModel[i];
    }

    public void setLicenseModel(int i, com.flexnet.operations.webservices.LicenseModelIdentifierType _value) {
        this.licenseModel[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LicenseModelsListType)) return false;
        LicenseModelsListType other = (LicenseModelsListType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LicenseModelsListType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "licenseModelsListType"));
