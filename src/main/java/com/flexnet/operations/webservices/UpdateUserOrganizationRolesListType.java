/**
 * UpdateUserOrganizationRolesListType.java
 *
...
public class UpdateUserOrganizationRolesListType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.RoleIdentifierType[] role;

    public UpdateUserOrganizationRolesListType() {
    }
    ...
    /**
     * Gets the role value for this UpdateUserOrganizationRolesListType.
     * 
     * @return role
     */
    ...
    /**
     * Sets the role value for this UpdateUserOrganizationRolesListType.
     * 
     * @param role
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateUserOrganizationRolesListType)) return false;
        UpdateUserOrganizationRolesListType other = (UpdateUserOrganizationRolesListType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateUserOrganizationRolesListType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "updateUserOrganizationRolesListType"));
