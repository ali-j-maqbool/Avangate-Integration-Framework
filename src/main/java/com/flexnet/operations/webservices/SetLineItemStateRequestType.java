/**
 * SetLineItemStateRequestType.java
 *
...
public class SetLineItemStateRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.LineItemStateDataType[] lineItem;

    public SetLineItemStateRequestType() {
    }
    ...
    /**
     * Gets the lineItem value for this SetLineItemStateRequestType.
     * 
     * @return lineItem
     */
    ...
    /**
     * Sets the lineItem value for this SetLineItemStateRequestType.
     * 
     * @param lineItem
     */
    ...
    public com.flexnet.operations.webservices.LineItemStateDataType getLineItem(int i) {
        return this.lineItem[i];
    }

    public void setLineItem(int i, com.flexnet.operations.webservices.LineItemStateDataType _value) {
        this.lineItem[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SetLineItemStateRequestType)) return false;
        SetLineItemStateRequestType other = (SetLineItemStateRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SetLineItemStateRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "setLineItemStateRequestType"));
