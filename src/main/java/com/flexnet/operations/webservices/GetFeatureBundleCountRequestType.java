/**
 * GetFeatureBundleCountRequestType.java
 *
...
public class GetFeatureBundleCountRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.FeatureBundleQueryParametersType queryParams;

    public GetFeatureBundleCountRequestType() {
    }
    ...
    /**
     * Gets the queryParams value for this GetFeatureBundleCountRequestType.
     * 
     * @return queryParams
     */
    ...
    /**
     * Sets the queryParams value for this GetFeatureBundleCountRequestType.
     * 
     * @param queryParams
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetFeatureBundleCountRequestType)) return false;
        GetFeatureBundleCountRequestType other = (GetFeatureBundleCountRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetFeatureBundleCountRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "getFeatureBundleCountRequestType"));
