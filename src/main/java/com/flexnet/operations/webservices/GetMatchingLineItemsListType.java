/**
 * GetMatchingLineItemsListType.java
 *
...
public class GetMatchingLineItemsListType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.GetMatchingLineItemInfoType[] lineItemInfo;

    public GetMatchingLineItemsListType() {
    }
    ...
    /**
     * Gets the lineItemInfo value for this GetMatchingLineItemsListType.
     * 
     * @return lineItemInfo
     */
    ...
    /**
     * Sets the lineItemInfo value for this GetMatchingLineItemsListType.
     * 
     * @param lineItemInfo
     */
    ...
    public com.flexnet.operations.webservices.GetMatchingLineItemInfoType getLineItemInfo(int i) {
        return this.lineItemInfo[i];
    }

    public void setLineItemInfo(int i, com.flexnet.operations.webservices.GetMatchingLineItemInfoType _value) {
        this.lineItemInfo[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetMatchingLineItemsListType)) return false;
        GetMatchingLineItemsListType other = (GetMatchingLineItemsListType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetMatchingLineItemsListType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "getMatchingLineItemsListType"));
