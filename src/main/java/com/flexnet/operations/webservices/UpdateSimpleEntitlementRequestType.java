/**
 * UpdateSimpleEntitlementRequestType.java
 *
...
public class UpdateSimpleEntitlementRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.UpdateSimpleEntitlementDataType[] simpleEntitlement;

    public UpdateSimpleEntitlementRequestType() {
    }
    ...
    /**
     * Gets the simpleEntitlement value for this UpdateSimpleEntitlementRequestType.
     * 
    ...
    /**
     * Sets the simpleEntitlement value for this UpdateSimpleEntitlementRequestType.
     * 
    ...
    public com.flexnet.operations.webservices.UpdateSimpleEntitlementDataType getSimpleEntitlement(int i) {
        return this.simpleEntitlement[i];
    }

    public void setSimpleEntitlement(int i, com.flexnet.operations.webservices.UpdateSimpleEntitlementDataType _value) {
        this.simpleEntitlement[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateSimpleEntitlementRequestType)) return false;
        UpdateSimpleEntitlementRequestType other = (UpdateSimpleEntitlementRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateSimpleEntitlementRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "updateSimpleEntitlementRequestType"));
