/**
 * RelateOrganizationsRequestType.java
 *
...
public class RelateOrganizationsRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.RelateOrganizationsDataType[] orgData;

    public RelateOrganizationsRequestType() {
    }
    ...
    /**
     * Gets the orgData value for this RelateOrganizationsRequestType.
     * 
     * @return orgData
     */
    ...
    /**
     * Sets the orgData value for this RelateOrganizationsRequestType.
     * 
     * @param orgData
     */
    ...
    public com.flexnet.operations.webservices.RelateOrganizationsDataType getOrgData(int i) {
        return this.orgData[i];
    }

    public void setOrgData(int i, com.flexnet.operations.webservices.RelateOrganizationsDataType _value) {
        this.orgData[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RelateOrganizationsRequestType)) return false;
        RelateOrganizationsRequestType other = (RelateOrganizationsRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RelateOrganizationsRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "relateOrganizationsRequestType"));
