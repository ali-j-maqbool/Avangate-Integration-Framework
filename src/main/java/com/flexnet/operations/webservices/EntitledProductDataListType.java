...
public class EntitledProductDataListType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.EntitledProductDataType[] entitledProduct;

    public EntitledProductDataListType() {
    }

    public EntitledProductDataListType(
           com.flexnet.operations.webservices.EntitledProductDataType[] entitledProduct) {
     ...
     */
    public com.flexnet.operations.webservices.EntitledProductDataType[] getEntitledProduct() {
        return entitledProduct;
    }
     ...
     */
    public void setEntitledProduct(com.flexnet.operations.webservices.EntitledProductDataType[] entitledProduct) {
        this.entitledProduct = entitledProduct;
    }

    public com.flexnet.operations.webservices.EntitledProductDataType getEntitledProduct(int i) {
        return this.entitledProduct[i];
    }

    public void setEntitledProduct(int i, com.flexnet.operations.webservices.EntitledProductDataType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "entitledProductDataListType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entitledProduct");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "entitledProduct"));
