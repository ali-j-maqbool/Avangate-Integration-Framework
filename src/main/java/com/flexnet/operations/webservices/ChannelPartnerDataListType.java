...
public class ChannelPartnerDataListType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.ChannelPartnerDataType[] channelPartner;

    public ChannelPartnerDataListType() {
    }

    public ChannelPartnerDataListType(
           com.flexnet.operations.webservices.ChannelPartnerDataType[] channelPartner) {
     ...
     */
    public com.flexnet.operations.webservices.ChannelPartnerDataType[] getChannelPartner() {
        return channelPartner;
    }
     ...
     */
    public void setChannelPartner(com.flexnet.operations.webservices.ChannelPartnerDataType[] channelPartner) {
        this.channelPartner = channelPartner;
    }

    public com.flexnet.operations.webservices.ChannelPartnerDataType getChannelPartner(int i) {
        return this.channelPartner[i];
    }

    public void setChannelPartner(int i, com.flexnet.operations.webservices.ChannelPartnerDataType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "channelPartnerDataListType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("channelPartner");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "channelPartner"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "channelPartnerDataType"));
