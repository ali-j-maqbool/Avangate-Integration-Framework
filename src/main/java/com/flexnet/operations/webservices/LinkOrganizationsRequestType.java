/**
 * LinkOrganizationsRequestType.java
 *
...
public class LinkOrganizationsRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.LinkOrganizationsDataType[] orgData;

    public LinkOrganizationsRequestType() {
    }
    ...
    /**
     * Gets the orgData value for this LinkOrganizationsRequestType.
     * 
     * @return orgData
     */
    ...
    /**
     * Sets the orgData value for this LinkOrganizationsRequestType.
     * 
     * @param orgData
     */
    ...
    public com.flexnet.operations.webservices.LinkOrganizationsDataType getOrgData(int i) {
        return this.orgData[i];
    }

    public void setOrgData(int i, com.flexnet.operations.webservices.LinkOrganizationsDataType _value) {
        this.orgData[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LinkOrganizationsRequestType)) return false;
        LinkOrganizationsRequestType other = (LinkOrganizationsRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LinkOrganizationsRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "linkOrganizationsRequestType"));
