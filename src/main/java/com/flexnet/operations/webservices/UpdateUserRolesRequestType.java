/**
 * UpdateUserRolesRequestType.java
 *
...
public class UpdateUserRolesRequestType  implements java.io.Serializable {
    private com.flexnet.operations.webservices.UpdateUserRolesDataType[] userData;

    public UpdateUserRolesRequestType() {
    }
    ...
    /**
     * Gets the userData value for this UpdateUserRolesRequestType.
     * 
     * @return userData
     */
    ...
    /**
     * Sets the userData value for this UpdateUserRolesRequestType.
     * 
     * @param userData
     */
    ...
    public com.flexnet.operations.webservices.UpdateUserRolesDataType getUserData(int i) {
        return this.userData[i];
    }

    public void setUserData(int i, com.flexnet.operations.webservices.UpdateUserRolesDataType _value) {
        this.userData[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateUserRolesRequestType)) return false;
        UpdateUserRolesRequestType other = (UpdateUserRolesRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateUserRolesRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.macrovision:flexnet/operations", "updateUserRolesRequestType"));
